...
*(Добавь сюда скриншоты работы бота: , , )*
### Главное меню
...
☁️ Деплой на Render
Бот успешно развёрнут на платформе Render с использованием вебхуков (не long polling). Это обеспечивает стабильную работу и экономию ресурсов.
