...
bot.hears('🩹 Уход за тату', async (ctx) => {
  ...
  if (daysPassed <= 3) {
    carePlan = `🎯 <b>День ${daysPassed + 1} из 3: Первичный уход</b>\n\n` +
      ...
      '• Наносите тонкий слой Бепантена, Пантенола или Митилоурициловой мази(Последний более дешёвый аналог)\n' +
...
bot.action('problem_redness', async (ctx) => {
  ...
  await ctx.editMessageText(
    ...
    '4. Нанести тонкий слой Бепантена, Пантенола или Митилоурициловой мази(Последний более дешёвый аналог)\n' +
...
bot.action('problem_peeling', async (ctx) => {
  ...
  await ctx.editMessageText(
    ...
    '• Бепантен (декспантенол 5%), Пантенола или Митилоурициловой мази(Последний более дешёвый аналог)\n' +
    '• Пантенол спрей\n' +
...
bot.action('taboo_cosmetics', async (ctx) => {
  ...
  await ctx.editMessageText(
    ...
    '• Бепантена, Пантенола или Митилоурициловой мази(Последний более дешёвый аналог)\n' +
...
bot.action('question_creams', async (ctx) => {
  ...
  await ctx.editMessageText(
    ...
    '• <b style="color: #e40d0d;">Митилоурициловой мази</b> - более дешёвый аналог для заживления и снятия воспаления\n'+
